        ...
        String newDate = mFormat.format(mDate);
            ...
            if(view.getId()==R.id.startBtn) {
                ...
                if(newAdd==null || newAdd.equals("") || newTime==null || newTime.equals("")||newTel==null||newTel.equals("")) {
                    ...
                    db.execSQL("insert into tb_newlist (newaddress,newlatitude,newlongitude,newDate,newtime,newtel) values (?,?,?,?,?,?)",
                            new String[]{newAdd, newLatitude, newLongitude, newDate,newTime, newTel});
                    db.close();
